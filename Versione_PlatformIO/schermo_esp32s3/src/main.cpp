...
// Funzioni di connessione e sistema
void connessioneWiFi();
void connessioneNTP();
void touch_calibrate();
void checkInactivity();

// Funzioni Grafiche e Icone
void drawWiFiSymbol(int x, int y);
void drawGearIcon(int x, int y);
void drawArrows();
void drawHouse();
void drawScrollBar(int x, int y, int w, int h); // Ho ipotizzato 4 parametri int
void printEventsTFT();
void printTasksTFT();
...
int touchMenu(int stato); // Ritorna un int

// Funzioni Calendario (Attenzione: controlla se i tipi coincidono col tuo codice!)
